...
![&#x4E91;&#x8BA1;&#x7B97;&#x6F14;&#x8FDB;&#x5386;&#x7A0B;](../.gitbook/assets/cloud-computing-evolution-road.jpg)

云原生应用到2020年将比目前至少翻一番，下图是Marc Wilczek的调查报告。

![&#x6765;&#x81EA;Twitter @MarcWilczek](../.gitbook/assets/cloud-native-comes-of-age.jpg)
...
![Cloud native&#x601D;&#x7EF4;&#x5BFC;&#x56FE;](../.gitbook/assets/cloud-native-architecutre-mindnode.jpg)
...
![&#x5341;&#x4E8C;&#x56E0;&#x7D20;&#x5E94;&#x7528;](../.gitbook/assets/12-factor-app.png)
...
![&#x5BB9;&#x5668;&#x751F;&#x6001;](../.gitbook/assets/container-ecosystem.png)

关于 Docker 容器的更多内容请参考 [Docker最佳实践](../fu-lu/docker-best-practice.md)。
...
使用二进制部署 `kubernetes` 集群的所有组件和插件，而不是使用 `kubeadm` 等自动化方式来部署集群，同时开启了集群的TLS安全认证，这样可以帮助我们了解系统各组件的交互原理，进而能快速解决实际问题。详见[在CentOS上部署Kubernetes集群](../zui-jia-shi-jian/install-kubernetes-on-centos/)。
...
1. [创建 TLS 证书和秘钥](../zui-jia-shi-jian/install-kubernetes-on-centos/create-tls-and-secret-key.md)
2. [创建kubeconfig文件](../zui-jia-shi-jian/install-kubernetes-on-centos/create-kubeconfig.md)
3. [创建高可用etcd集群](../zui-jia-shi-jian/install-kubernetes-on-centos/etcd-cluster-installation.md)
4. [安装kubectl命令行工具](../zui-jia-shi-jian/install-kubernetes-on-centos/kubectl-installation.md)
5. [部署master节点](../zui-jia-shi-jian/install-kubernetes-on-centos/master-installation.md)
6. [安装flannel网络插件](../zui-jia-shi-jian/install-kubernetes-on-centos/flannel-installation.md)
7. [部署node节点](../zui-jia-shi-jian/install-kubernetes-on-centos/node-installation.md)
8. [安装kubedns插件](../zui-jia-shi-jian/install-kubernetes-on-centos/kubedns-addon-installation.md)
9. [安装dashboard插件](../zui-jia-shi-jian/install-kubernetes-on-centos/dashboard-addon-installation.md)
10. [安装heapster插件](../zui-jia-shi-jian/install-kubernetes-on-centos/heapster-addon-installation.md)
11. [安装EFK插件](../zui-jia-shi-jian/install-kubernetes-on-centos/efk-addon-installation.md)
...
![&#x4F7F;&#x7528;Jenkins&#x8FDB;&#x884C;&#x6301;&#x7EED;&#x96C6;&#x6210;&#x4E0E;&#x53D1;&#x5E03;&#x6D41;&#x7A0B;&#x56FE;](../.gitbook/assets/kubernetes-jenkins-ci-cd.png)
...
![filebeat&#x65E5;&#x5FD7;&#x6536;&#x96C6;&#x67B6;&#x6784;&#x56FE;](../.gitbook/assets/filebeat-log-collector-arch.png)
...
![API&#x6587;&#x6863;](../.gitbook/assets/k8s-app-monitor-test-api-doc.jpg)
...
![&#x8FC1;&#x79FB;&#x6B65;&#x9AA4;&#x793A;&#x610F;&#x56FE;](../.gitbook/assets/migrating-hadoop-yarn-to-kubernetes.png)
...
![service mesh&#x67B6;&#x6784;&#x56FE;](../.gitbook/assets/serivce-mesh-control-plane.png)
...
![kibana&#x754C;&#x9762;](../.gitbook/assets/filebeat-docker-test.jpg)
...
![Grafana&#x754C;&#x9762;&#x793A;&#x610F;&#x56FE;1](../.gitbook/assets/kubernetes-devops-example-grafana-1.png)

Kubernetes集群全局监控图1

该监控图可以看到集群硬件使用情况。

![Grafana&#x754C;&#x9762;&#x793A;&#x610F;&#x56FE;2](../.gitbook/assets/kubernetes-devops-example-grafana-2.png)

Kubernetes全局监控图2

该监控可以看到单个用户的namespace下的所有资源的使用情况。

![Grafana&#x754C;&#x9762;&#x793A;&#x610F;&#x56FE;3](../.gitbook/assets/kubernetes-devops-example-grafana-3.png)
...
![dashboard](../.gitbook/assets/spark-job-on-kubernetes-example-1.jpg)

下图是从Grafana监控页面上查看到的某个executor资源占用情况。

![Grafana](../.gitbook/assets/spark-job-on-kubernetes-example-2.jpg)
