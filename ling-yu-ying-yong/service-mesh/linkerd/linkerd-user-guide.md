...
以下我们着重讲解在 kubernetes 中如何使用 linkerd 作为 kubernetes 的 Ingress controller，并作为边缘节点代替 [Traefik](https://traefik.io) 的功能，详见 [边缘节点的配置](../../../zui-jia-shi-jian/service-discovery-and-loadbalancing/edge-node-configuration.md)。
...
![Jenkins pipeline](../../../.gitbook/assets/linkerd-jenkins-pipeline.jpg)

![Jenkins config](../../../.gitbook/assets/linkerd-jenkins.jpg)
...
![namerd](../../../.gitbook/assets/namerd-internal.jpg)
...
为了在本地调试 linkerd，我们将 linkerd 的 service 加入到 ingress 中，详见 [边缘节点配置](../../../zui-jia-shi-jian/service-discovery-and-loadbalancing/edge-node-configuration.md)。
...
![linkerd&#x76D1;&#x63A7;](../../../.gitbook/assets/linkerd-helloworld-outgoing.jpg)

Incoming

![linkerd&#x76D1;&#x63A7;](../../../.gitbook/assets/linkerd-helloworld-incoming.jpg)

访问 `http://linkerd-viz.jimmysong.io` 查看应用 metric 监控

![linkerd&#x6027;&#x80FD;&#x76D1;&#x63A7;](../../../.gitbook/assets/linkerd-grafana.png)
...
将 Linkerd 作为 kubernetes ingress controller 的方式跟将 Treafik 作为 ingress controller 的过程过程完全一样，可以直接参考 [边缘节点配置](../../../zui-jia-shi-jian/service-discovery-and-loadbalancing/edge-node-configuration.md)。

架构如下图所示。

![Linkerd ingress controller](../../../.gitbook/assets/linkerd-ingress-controller.jpg)

_\(图片来自 A Service Mesh for Kubernetes - Buoyant.io\)_
