...
部署时需要使用的配置文件和`vagrantfile`请见：[https://github.com/rootsongjc/kubernetes-vagrant-centos-cluster](https://github.com/rootsongjc/kubernetes-vagrant-centos-cluster)
...
| tracing | [http://172.17.8.101:$JAEGER\_PORT](http://172.17.8.101:$JAEGER_PORT) |
| productpage | [http://172.17.8.101:$GATEWAY\_PORT/productpage](http://172.17.8.101:$GATEWAY_PORT/productpage) |
