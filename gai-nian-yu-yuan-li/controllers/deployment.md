...
![kubernetes deployment cheatsheet](../../.gitbook/assets/deployment-cheatsheet.png)

## Deployment 概念详细解析

本文翻译自kubernetes官方文档：[https://kubernetes.io/docs/concepts/workloads/controllers/deployment](https://kubernetes.io/docs/concepts/workloads/controllers/deployment)
