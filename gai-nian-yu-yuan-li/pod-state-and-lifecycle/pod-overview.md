...
![pod diagram](../../.gitbook/assets/pod-overview.png)
...
Pod模版是包含了其他object的Pod定义，例如[Replication Controllers](../controllers/replicaset.md)，[Jobs](../controllers/job.md)和 [DaemonSets](../controllers/daemonset.md)。Controller根据Pod模板来创建实际的Pod。
