...
![Helm chart&#x6E90;](../../.gitbook/assets/helm-charts-repository.jpg)
...
关于Ingress配置请参考：[边缘节点配置](../service-discovery-and-loadbalancing/edge-node-configuration.md)
...
访问 [http://mean.jimmysong.io](http://mean.jimmysong.io) 可以看到如下界面，我在其中添加几条todo：

![TODO&#x5E94;&#x7528;&#x7684;Web&#x9875;&#x9762;](../../.gitbook/assets/helm-mean-todo-aholic.jpg)

**注**：Todo中的文字来自_What does the fox say？_
