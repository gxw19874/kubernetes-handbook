...
我们使用[helm](http://helm.sh)来部署，[chart](https://github.com/kubernetes/charts)保存在私有的仓库中，请确保您已经安装和配置好helm，helm安装使用见[使用Helm管理kubernetes应用](../services-management-tool/helm.md)。
...
* gcr.io/google\_containers/nginx-ingress-controller:0.9.0-beta.15
* gcr.io/google\_containers/defaultbackend:1.3
...
* http地址：[http://172.20.0.113:30484](http://172.20.0.113:30484)
* https地址：[https://172.20.0.113:31053](https://172.20.0.113:31053)
...
* [使用Helm管理kubernetes应用](../services-management-tool/helm.md)
